...
#include "RoNCameraMod/NewActorComponent.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	RONCAMERAMOD_API UClass* Z_Construct_UClass_UNewActorComponent_NoRegister();
	RONCAMERAMOD_API UClass* Z_Construct_UClass_UNewActorComponent();
	ENGINE_API UClass* Z_Construct_UClass_UActorComponent();
	UPackage* Z_Construct_UPackage__Script_RoNCameraMod();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_UNewActorComponent_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_RoNCameraMod,
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UNewActorComponent, 430921989);
	template<> RONCAMERAMOD_API UClass* StaticClass<UNewActorComponent>()
	{
		return UNewActorComponent::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UNewActorComponent(Z_Construct_UClass_UNewActorComponent, &UNewActorComponent::StaticClass, TEXT("/Script/RoNCameraMod"), TEXT("UNewActorComponent"), false, nullptr, nullptr, nullptr);

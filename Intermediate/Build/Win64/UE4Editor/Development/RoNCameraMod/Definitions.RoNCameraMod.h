...
#define UE_PROJECT_NAME RoNCameraMod
#define UE_TARGET_NAME RoNCameraModEditor
#define UE_MODULE_NAME "RoNCameraMod"
...
#define RONCAMERAMOD_API DLLEXPORT
